...
import {
  saveGuitarNicheForm,
  updateCompaign,
} from "../actions/guitarNicheAction";
...
export class GuitarNiche extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveGuitarNicheForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.guitarNicheReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.guitarNicheReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(GuitarNiche);
