...
import {
  saveDogTrainingForm,
  updateCompaign,
} from "../actions/dogTrainingAction";
...
class DogTraining extends Component {
  constructor(props) {
    super(props);
    this.state = {
      benefits: ["", "", ""],
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveDogTrainingForm(data);
  };
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.dogTrainingArray !== this.props.dogTrainingArray &&
      this.props.dogTrainingArray !== ""
    ) {
...
const mapsToprops = (state) => {
  return {
    dogTrainingArray: state.dogTrainingReducer.dogTrainingArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.dogTrainingReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(DogTraining);
