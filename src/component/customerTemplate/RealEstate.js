...
class RealEstate extends Component {
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveRealEstateForm(data);
  };
  updateCompaignData = () => {
    const data = {
      name: this.state.name,
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.realEstateArray !== this.props.realEstateArray &&
      this.props.realEstateArray !== ""
    ) {
...
const mapsToprops = (state) => {
  return {
    realEstateArray: state.realEstateReducer.realEstateArray,
    ...
    update_response: state.realEstateReducer.update_response,
  };
};

export default connect(mapsToprops, action)(RealEstate);
