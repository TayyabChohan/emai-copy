...
import {
  savePhotographyNicheForm,
  updateCompaign,
} from "../actions/photographyNicheAction";
...
class PhotographyNiche extends Component {
  constructor(props) {
    super(props);
    this.state = {
      benefits: ["", "", ""],
  ...
  handlensubmit = (e) => {
    ...
    this.props.savePhotographyNicheForm(data);
  };
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.photographyNicheArray !== this.props.photographyNicheArray &&
      this.props.photographyNicheArray !== ""
    ) {
  ...
  render() {
    const { name, clickbank_id } = this.state;
    return (
      <section>
...
const mapsToprops = (state) => {
  return {
    photographyNicheArray: state.photographyNicheReducer.photographyNicheArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.photographyNicheReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(PhotographyNiche);
