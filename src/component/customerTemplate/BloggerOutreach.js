...
import {
  saveBloggerOutreachForm,
  updateCompaign,
} from "../actions/bloggerOutreachAction.js";
...
export class BloggerOutreach extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveBloggerOutreachForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.BloggerOutreachReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.BloggerOutreachReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};
export default connect(mapsToprops, action)(BloggerOutreach);
