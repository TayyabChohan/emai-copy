...
import { saveDrawingForm, updateCompaign } from "../actions/drawingAction.js";
...
export class Drawing extends Component {
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveDrawingForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.drawingReducer.templateFormArray,
    ...
    update_response: state.drawingReducer.update_response,
  };
};

export default connect(mapsToprops, action)(Drawing);
