...
import {
  saveBusinessDevelopmentForm,
  updateCompaign,
} from "../actions/businessDevelopmentAction";
...
export class BusinessDevelopment extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveBusinessDevelopmentForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.businessDevelopmentReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.businessDevelopmentReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(BusinessDevelopment);
