...
import {
  saveWebinarReplaySeqForm,
  updateCompaign,
} from "../actions/webinarReplaySequenceAction";
...
export class WebinarReplaySequence extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveWebinarReplaySeqForm(data);
  };
      ...
      <section>
        <div className="container">
          ...
          <form id="statusCheck" onSubmit={this.handlensubmit}>
            ...
            <div className="row  pl-5 pr-5">
              <label className="pl-3 pr-5">
                Webinar Reply Sequence Benefits{" "}
                <span className="required" style={{ color: "red" }}>
                  *
                </span>{" "}
              </label>
            ...
            {this.state.dynamicBenefits.map((item, index) => (
              <div className="row pl-5 pr-5">
                <div className="col-md-10 col-xs-10 col-sm-10 col-lg-10">
                  <div className="form-group has-feedback">
                    {/* <span>
                  <i className="fa fa-trash"></i>
                    ...
                    <input
                      ...
                      name="benefits"
                      required
                      onChange={(e) => this.handleOnchangeProgram(e, index)}
                      value={item}
                    />
                  </div>
                </div>
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.webinarReplaySequenceReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.webinarReplaySequenceReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(WebinarReplaySequence);
