...
import {
  savePostWabinarForm,
  updateCompaign,
} from "../actions/postWabinarAction";
import {
...
export class PostWebinarEmail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      documents: [],
  ...
  handleOnsubmit = (e) => {
    ...
    this.props.savePostWabinarForm(data);
  };
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.savePostWabinarArray !== this.props.savePostWabinarArray &&
      this.props.savePostWabinarArray !== ""
    ) {
              ...
              <div className="col-md-12 col-sm-12 col-lg-12">
                <div className="form-group has-feedback">
                  <input
                    ...
                    onChange={this.handleChange}
                    required
                    placeholder="Enter Order Form Link"
                  ></input>
                </div>
              </div>
            </div>
...
const mapStateToProps = (state) => {
  return {
    savePostWabinarArray: state.postWabinarReducer.savePostWabinarArray,
    ...
    update_response: state.postWabinarReducer.update_response,
    template_list_array: state.templatesReducer.template_list_array,
  };
};

export default connect(mapStateToProps, action)(PostWebinarEmail);
