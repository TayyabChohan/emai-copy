...
class MenFitness extends Component {
  constructor(props) {
    super(props);
    this.state = {
      benefits: ["", "", ""],
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveMenFitnessForm(data);
  };
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.menFitnessArray !== this.props.menFitnessArray &&
      this.props.menFitnessArray !== ""
    ) {
...
const mapsToprops = (state) => {
  return {
    menFitnessArray: state.menFitnessReducer.menFitnessArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.menFitnessReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(MenFitness);
