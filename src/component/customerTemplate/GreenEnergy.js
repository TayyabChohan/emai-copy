...
import {
  saveGreenEnergyForm,
  updateCompaign,
} from "../actions/greenEnergyAction";
...
export class GreenEnergy extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveGreenEnergyForm(data);
  };
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      ...
      // console.log(this.props.templateFormArray)
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.greenEnergyReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.greenEnergyReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(GreenEnergy);
