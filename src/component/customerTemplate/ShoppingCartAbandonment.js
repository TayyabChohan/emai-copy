...
import {
  saveShoppingCartAbandonmentForm,
  updateCompaign,
} from "../actions/shoppingCartAbandonmentAction";
...
export class ShoppingCartAbandonment extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveShoppingCartAbandonmentForm(data);
  };
  componentDidUpdate(prevProps, prevState) {
    if (
      ...
      this.setState({
        ...
        order_link: this.props.templates_questions_data.result.order_link,
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.shoppingCartAbandonmentReducer.templateFormArray,
    ...
    update_response: state.shoppingCartAbandonmentReducer.update_response,
  };
};

export default connect(mapsToprops, action)(ShoppingCartAbandonment);

// export default ShoppingCartAbandonment;
