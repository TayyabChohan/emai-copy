...
import {
  saveSurvivalNicheForm,
  updateCompaign,
} from "../actions/survivalNicheAction";
...
export class SurvivalNiche extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveSurvivalNicheForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.survivalNicheReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.survivalNicheReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(SurvivalNiche);
