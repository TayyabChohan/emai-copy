...
export class MensDating extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveMensDatingForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.mensDatingReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.mensDatingReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(MensDating);
