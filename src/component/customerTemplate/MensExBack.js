...
export class MensExBack extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveMensExBackForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.mensExBackReducer.templateFormArray,
    ...
    update_response: state.mensExBackReducer.update_response,
  };
};

export default connect(mapsToprops, action)(MensExBack);
