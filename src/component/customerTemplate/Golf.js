...
import { saveGolfForm, updateCompaign } from "../actions/golfAction";
  ...
  componentDidMount() {
    ...
    if (this.props.match.params.saveOrUpdate === "save") {
      const data_home = {
        ...
        campaignId: parseInt(this.props.match.params.saveOrUpdate),
      };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.golfReducer.templateFormArray,
    ...
    update_response: state.golfReducer.update_response,
  };
};

export default connect(mapsToprops, action)(Golf);
