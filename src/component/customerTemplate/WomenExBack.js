...
import {
  savewomenExbackForm,
  updateCompaign,
} from "../actions/womenExbackAction";
...
class WomenExBack extends Component {
  constructor(props) {
    super(props);
    this.state = {
      benefits: ["", "", ""],
  ...
  handlensubmit = (e) => {
    ...
    this.props.savewomenExbackForm(data);
  };
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.womenexbackArray !== this.props.womenexbackArray &&
      this.props.womenexbackArray !== ""
    ) {
...
const mapsToprops = (state) => {
  return {
    womenexbackArray: state.womenExbackReducer.womenexbackArray,
    ...
    update_response: state.womenExbackReducer.update_response,
  };
};

export default connect(mapsToprops, action)(WomenExBack);
