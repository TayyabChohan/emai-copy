...
import { saveMindBrainForm, updateCompaign } from "../actions/mindBrainAction";
...
export class MindBrain extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveMindBrainForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.mindBrainReducer.templateFormArray,
    ...
    update_response: state.mindBrainReducer.update_response,
  };
};

export default connect(mapsToprops, action)(MindBrain);
