...
import {
  saveBusinessOpportunityForm,
  updateCompaign,
} from "../actions/businessOpportunityAction";
...
export class BusinessOpportunity extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveBusinessOpportunityForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.businessOpportunityReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.businessOpportunityReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(BusinessOpportunity);
