...
import { saveWeddingsForm, updateCompaign } from "../actions/weddingsAction";
...
export class Weddings extends Component {
  ...
  handlensubmit = (e) => {
    ...
    this.props.saveWeddingsForm(data);
  };
...
const mapsToprops = (state) => {
  return {
    templateFormArray: state.weddingsReducer.templateFormArray,
    template_list_array: state.templatesReducer.template_list_array,
    update_response: state.weddingsReducer.update_response,
    templates_questions_data: state.templatesReducer.templates_questions_data,
  };
};

export default connect(mapsToprops, action)(Weddings);
