...
export const saveColdProspectingForm = (data) => {
  return (dispatch) => {
    const options = {
      method: "POST",
      url: `${process.env.REACT_APP_API_URL}coldSimpleProspectingEmailTemplate`,
      data: data,
    };
    axios(options)
      .then((response) => {
        if (response.data.success === true) {
          dispatch({
            type: SAVE_TEMPLATE_COLD_PROSPECTING,
...
export const updateCompaign = (data) => {
  return (dispatch) => {
    const options = {
      method: "POST",
      url: `${process.env.REACT_APP_API_URL}updateColdSimpleProspectingEmailTemplate`,
      data: data,
    };
    axios(options)
      .then((response) => {
