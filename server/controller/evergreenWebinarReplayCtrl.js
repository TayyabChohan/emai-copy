...
exports.webinarReplayTemplate = (req, res) => {
  Campaign.create({
    description: "",
    downloads: 0,
        ...
        Email.findAll({
          ...
          .then((emailData) => {
            for (let i = 0; i < emailData.length; i++) {
              ...
              let mapObj = {
                "#CallToActionLink": req.body.call_to_action_link,
              ...
              customEmailBody = customEmailBody.replace(
                /#WebinarTopic|#CallToAction|#WebinarDay|#ProgramBenefits|#YourName|#Benefits/gi,
                function (matched) {
...
exports.updateWebinarReplayTemplate = (req, res) => {
  WebinarReplay.update(
    {
      host: req.body.host,
      name: req.body.name,
      topic: req.body.topic,
