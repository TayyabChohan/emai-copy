...
exports.bloggerOutreachTemplate = (req, res) => {
  Campaign.create({
    description: "",
    downloads: 0,
          ...
          .then((emailData) => {
            for (let i = 0; i < emailData.length; i++) {
              ...
              customEmailBody = customEmailBody.replace(
                /#ProductType|#ProductName|#ProductDescription|#YourName/gi,
                function (matched) {
...
exports.updateBloggerOutreachTemplate = (req, res) => {
  BloggerOutreach.update(
    {
      name: req.body.name,
      product_type: req.body.product_type,
      product_name: req.body.product_name,
